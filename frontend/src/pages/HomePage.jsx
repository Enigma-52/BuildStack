  ...
  const featuredProducts = [
    {
      ...
      description: "Revolutionary AI-powered writing tool with advanced features for content creators.",
    ...
    },
    {
      ...
      description: "Professional design tool suite with advanced features for UI/UX designers.",
      image: "/api/placeholder/600/400",
      category: "Design",
      featured: true,
      upvotes: 867,
