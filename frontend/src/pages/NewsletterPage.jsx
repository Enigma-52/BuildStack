		...
		<div>
			...
			<div className="min-h-screen bg-gradient-to-r from-pink-50 via-blue-50 to-orange-50 pt-32 pb-10">
				<div className="max-w-6xl mx-auto px-4">
					{/* Hero Section */}
					<div className={`text-center mb-12 transition-all duration-1000 ${animationPlayed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
						}`}>
						...
						<div className="flex justify-center gap-8 mb-12">
							{stats.map((stat, index) => (
								<div
									key={index}
									className={`transition-all duration-1000 delay-${index + 1}00 ${animationPlayed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
										}`}
								>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						{[
							...
							<div
								key={index}
								className={`bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 ${animationPlayed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
									}`}
