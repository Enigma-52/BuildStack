...
const Button = ({ children, className = '', variant = 'default', size = 'default', ...props }) => {
  ...
  const variants = {
    ...
    outline: 'border border-gray-300 bg-white hover:bg-orange-50 text-gray-700 hover:text-orange-600',
...
const DiscussionsPage = () => {
  ...
  const discussions = [
    {
      id: 1,
      title: "What's your secret to getting more views on content without spending on ads?",
      ...
      >
        ...
        <div className="flex-grow space-y-3">
          <div className="space-y-2">
            ...
            <h3 className="font-medium text-lg text-gray-900 group-hover:text-orange-600 
            ...
            <div className="flex-grow md:max-w-3xl">
              <div className="flex justify-between items-center mb-8">
                <div>
                  ...
                  <p className="text-gray-600 mt-2">Ask questions, find support, and connect with the community.</p>
                </div>
        ...
        >
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              {selectedDiscussion.category && (
                <Badge className="bg-orange-100 text-orange-600">{selectedDiscussion.category}</Badge>
              )}
            </div>
          ...
          <div className="prose max-w-none">
            <p className="text-gray-700 leading-relaxed">
              {selectedDiscussion.content || "Hey everyone! I'm excited to discuss this topic with you all. Feel free to share your thoughts and experiences."}
            </p>
          </div>
            ...
            <div className="max-h-[400px] overflow-y-auto pr-4 -mr-4 space-y-6">
                ...
                >
                    ...
                    <p className="text-gray-700">
                        This is a great discussion topic! I've found that engaging with the community regularly and providing value is key to organic growth.
                    </p>
                    </div>
                </motion.div>
                ))}
