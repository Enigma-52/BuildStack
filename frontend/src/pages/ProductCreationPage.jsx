						...
						<div className="space-y-2">
							{tabs.map((tab) => (
								<button
									...
									className={`w-full text-left p-4 rounded-lg transition-all duration-200 ${activeTab === tab.id
								...
								>
									...
									<p className={`mt-1 text-sm ${activeTab === tab.id ? 'text-orange-100' : 'text-gray-500'
										}`}>
										{tab.description}
									</p>
								</button>
