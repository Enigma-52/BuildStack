...
import { Bell, Mail, Star, AlertCircle, Check, Trash2, Share2 } from 'lucide-react';
...
const NotificationsPage = () => {
  const [notifications, setNotifications] = useState([
    ...
    },
    {
      ...
      description: "Congratulations! You're in the running for Product of the Day",
      time: '2 hours ago',
      read: true,
    },
    {
  ...
  return (
    <div className="flex flex-col min-h-screen">
        <Navbar />
    <div className="pt-24 min-h-screen bg-gray-50/50 py-8">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">Stay updated with your product's activity</p>
              </div>
            </div>
            {unreadCount > 0 && (
          ...
          <div className="divide-y divide-gray-100">
            ...
            {notifications.length === 0 && (
              <div className="px-6 py-12 text-center">
                ...
                <p className="mt-2 text-sm text-gray-500">No new notifications at the moment.</p>
              </div>
            )}
          </div>
        </div>
