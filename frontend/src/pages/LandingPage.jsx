          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Discover and evaluate the best development tools for your next project.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-600 hover:text-orange-500">Trending</a></li>
                <li><a href="#" className="text-gray-600 hover:text-orange-500">Compare Tools</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-600 hover:text-orange-500">Cookie Policy</a></li>
              </ul>
            </div>
          </div>
